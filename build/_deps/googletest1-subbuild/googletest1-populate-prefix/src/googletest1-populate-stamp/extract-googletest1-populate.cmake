...
#
get_filename_component(filename "C:/gitprojs/Data-Structures/build/_deps/googletest1-subbuild/googletest1-populate-prefix/src/03597a01ee50ed33e9dfd640b249b4be3799d395.zip" ABSOLUTE)
get_filename_component(directory "C:/gitprojs/Data-Structures/build/_deps/googletest1-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-googletest1-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-googletest1-populate${i}")
